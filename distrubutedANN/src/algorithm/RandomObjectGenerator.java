...
//	private static double minDistBetNodeAndObject;
	...
	public static void generateRandomObjectsOnEdgeWithCentroidForSameDistribution(CoreGraph graph,
	...
	public static void generateRandomObjectsOnEdgeWithCentroidGaussian(CoreGraph graph, int totalNumberOfTrueObjects,
	...
	// distance
	private static Map<Integer, Double> traverseFromGivenNodeUptoDistance(CoreGraph gr, int nodeId, double distance) {
	...
	private static void traverseUptoGivenDistance(CoreGraph graph, int nodeId, ArrayList<Integer> visitedNode,
	...
	public static void generateRandomObjectsOnEdgesWithCentroid(CoreGraph graph, int totalNumberOfTrueObjects,
	...
	public static void generateUniformRandomObjectsOnMap(CoreGraph graph, int totalNumberOfTrueObjects,
	...
	public static void generateRandomObjectsOnMap(CoreGraph graph, int totalNumberOfTrueObjects,
			int totalNumberOfFalseObjects) {
		...
		int totalNumOfObjects = totalNumberOfTrueObjects + totalNumberOfFalseObjects;
		for (cEdge edge : graph.getEdgesWithInfo()) {
	...
	public static void generateRandomObjectsOnMap1(CoreGraph graph) {
	...
	public static void generateRandomObjectsOnMap2(CoreGraph graph, double probOFTrueObjs) {
	...
	public static void generateRandomObjectsOnMap3(CoreGraph graph, double probOFTrueObjs, int objNumParam) {
	...
	public static void generateRandomObjectsOnMap5(CoreGraph graph, double probOFTrueObjs, int totalNumOfObjects) {
		// objNumParam refers to the minimum number of objects on the minimum edge - 1.
		// int edgeId = 0;
		int objCounter = 0;
		double distanceFromStartNode = 0.0;
	...
	public static void generateRandomObjectsOnMap4(CoreGraph graph, double probOFTrueObjs, int totalNumOfObjsOnMap) {
		// objNumParam refers to the minimum number of objects on the minimum edge - 1.
...
//	}
	...
	public static ArrayList<Integer> getEdgesWithinRadius(CoreGraph graph, double perimeter, int edgeId) {
	...
	public static int zcreateCentroidDistribution(CoreGraph graph, int objectCounter, double standardDeviationValue,
...
//	}
	...
	public static void zcreateUniformDistribution(CoreGraph graph, int objectCounter,
	...
	public static void zgenerateCUUCDistribution(CoreGraph graph, double standardDeviationValue, int scaleFactor,
	...
	public static void zgenerateUUDistribution(CoreGraph graph, int numberOfTrueObject, int numberOfFalseObject) {

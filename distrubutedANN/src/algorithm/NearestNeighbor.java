...
public class NearestNeighbor {
	...
	public RoadObject getNearestObjectToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
		...
		nonClearedNodeQueue
				.addAll(foundNodesWithSortedDistance.get(UtilsManagement.getMinimumKey(foundNodesWithSortedDistance)));
		nonClearedNodeQueue
				.addAll(foundNodesWithSortedDistance.get(UtilsManagement.getSecondKey(foundNodesWithSortedDistance)));
		int currentNode;
		...
		if (!foundObjectsWithSortedDistance.isEmpty()) {
			double nearestObjDist = UtilsManagement.getMinimumKey(foundObjectsWithSortedDistance);
			// System.out.println("Distance to the nearest Object: " + nearestObjDist);
			int nearestObjId = UtilsManagement
	...
	public int getNearestObjectIdToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
		return getNearestObjectToGivenObjOnMap(gr, sourceObjId).getObjectId();
	}

	public double getDistanceToNearestObjOnMap(CoreGraph gr, int sourceObjId) {
		m_graph = gr;
		...
		if (!foundObjectsWithSortedDistance.isEmpty()) {
			nearestObjDist = UtilsManagement.getMinimumKey(foundObjectsWithSortedDistance);
	...
	public Map<RoadObject, Double> getNearestTrueObjectToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
	...
	public int getNearestTrueObjectIdToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
	...
	public Map<RoadObject, Double> getNearestFalseObjectToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
...
//	}
	...
	public int getNearestFalseObjectIdToGivenObjOnMap(CoreGraph gr, int sourceObjId) {
